                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            16.0, 0.0, 16.0, 0.0),
                        child: Text(
                          'Manage and customize your financial plans',
                          style:
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            16.0, 0.0, 16.0, 0.0),
                        child: StreamBuilder<List<PricesDataRecord>>(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                listViewPricesDataRecord.active
                                                    ? 'True'
                                                    : 'False',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              FFButtonWidget(
                                                onPressed: () async {
                                                  await listViewPricesDataRecord
                                                      .reference
                                                      .delete();
                                                },
                                                text: 'Delete',
                      ...
                      Padding(
                        padding: const EdgeInsetsDirectional.fromSTEB(
                            16.0, 0.0, 16.0, 0.0),
                        child: Text(
                          'Tap on a plan to view details or edit. Use the \'Add Plan\' button to create a new plan.',
