      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => AdminWidget(
            approve: params.getParam(
              'approve',
              ParamType.int,
            ),
            notapprove: params.getParam(
              'notapprove',
              ParamType.int,
            ),
          ),
        ...
        FFRoute(
          name: 'fulllis',
          path: '/fulllis',
          builder: (context, params) => const FulllisWidget(),
        ),
        FFRoute(
          name: 'signup',
          path: '/signup',
        ...
        FFRoute(
          name: 'RecepShow',
          path: '/recepShow',
          builder: (context, params) => const RecepShowWidget(),
        ),
        FFRoute(
          name: 'event',
          path: '/event',
